...
function UIScrollButton.ScrollButtonEvent(isShow, parentPanel, targetUI, targetScroll)
	...
	if isShow and targetScroll:GetShow() then
		...
		--Panel_Scroll:SetShow(true, false)
		--Panel_Scroll:SetSize( targetUI:GetSizeX(), targetUI:GetSizeY() )
		--Panel_Scroll:SetPosX( parentPanel:GetPosX() + targetUI:GetPosX() )
		--Panel_Scroll:SetPosY( parentPanel:GetPosY() + targetUI:GetPosY() )
