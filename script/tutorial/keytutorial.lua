...
function TutorialUI:Show()
	...
	self._uiButtonW:SetColor(Defines.Color.C_FF444444)				self._uiButtonW:SetIgnore(true)				--_uiButtonW:SetShow(false)		
	self._uiButtonA:SetColor(Defines.Color.C_FF444444)   			self._uiButtonA:SetIgnore(true)			     	-- _uiButtonA:SetShow(false)		
	self._uiButtonS:SetColor(Defines.Color.C_FF444444)				self._uiButtonS:SetIgnore(true)			   	--_uiButtonS:SetShow(false)		
	self._uiButtonD:SetColor(Defines.Color.C_FF444444)				self._uiButtonD:SetIgnore(true)			     --_uiButtonD:SetShow(false)		 
	self._uiButtonF:SetColor(Defines.Color.C_FF444444)				self._uiButtonF:SetIgnore(true)			    	--_uiButtonF:SetShow(false)		
	self._uiButtonE:SetColor(Defines.Color.C_FF444444)				self._uiButtonE:SetIgnore(true)			    	--_uiButtonE:SetShow(false)		
	self._uiButtonML:SetColor(Defines.Color.C_FF444444)			self._uiButtonML:SetIgnore(true)				--_uiButtonML:SetShow(false)	    
	self._uiButtonMR:SetColor(Defines.Color.C_FF444444)			self._uiButtonMR:SetIgnore(true)	 	 	--_uiButtonMR:SetShow(false)	   
	self._uiButtonShift:SetColor(Defines.Color.C_FF444444)			self._uiButtonShift:SetIgnore(true)		    	--_uiButtonShift:SetShow(false)	 
	self._uiButtonSpace:SetColor(Defines.Color.C_FF444444)		self._uiButtonSpace:SetIgnore(true)	     	--_uiButtonSpace:SetShow(false)	
	self._uiButtonTab:SetColor(Defines.Color.C_FF444444)			self._uiButtonTab:SetIgnore(true)	 			--_uiButtonTab:SetShow(false)	   
end
...
function	Update_StepMove(deltaTime)
	...
	if(_updateGab < _updateTime) then
		...
		_updateTime = 0		
		if( 5 < Tutorial._pushed_time ) then
...
function	Update_StepKeyE(deltaTime)
	...
	if(_updateGab < _updateTime) then
		...
		_updateTime = 0
		if( 3 < Tutorial._pushed_time ) then
			Tutorial._currentTutorial:NextStep()
		end
	end
end
...
-- 공격 튜토리얼(클래스별로 다르게 만들자) 일단은 if로 처리했음
AttackTutorial = 
{
}
