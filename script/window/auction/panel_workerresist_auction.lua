...
function resistWorker:Update()
	...
	if workSpeedValue < workerWrapperLua:getWorkEfficiency(2) then	-- 거점생산
		workSpeedValue = workerWrapperLua:getWorkEfficiency(2)
	end
	if workSpeedValue < workerWrapperLua:getWorkEfficiency(5) then	-- 집제작
		workSpeedValue = workerWrapperLua:getWorkEfficiency(5)
	end
	if workSpeedValue < workerWrapperLua:getWorkEfficiency(6) then	-- 성채건설
		workSpeedValue = workerWrapperLua:getWorkEfficiency(6)
	end
	if workSpeedValue < workerWrapperLua:getWorkEfficiency(8) then	-- 대량생산
