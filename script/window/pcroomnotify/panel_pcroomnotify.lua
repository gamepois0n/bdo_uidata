...
function Panel_PcRoomNotify_ShowAni()
	...
	local aniInfo1 = Panel_PcRoomNotify:addScaleAnimation( 0.0, 0.08, UI_ANI_ADV.PAUI_ANIM_ADVANCE_COS_HALF_PI)
...
function Panel_PcRoomNotify_HideAni()
	...
	local aniInfo = UIAni.AlphaAnimation( 0, Panel_PcRoomNotify, 0.0, 0.1 )
...
registerEvent("FromClient_LoadCompleteMsg", "FromClient_IsPcRoomPlayer")		-- 로딩이 발생했을 경우 한번 호출해 주자