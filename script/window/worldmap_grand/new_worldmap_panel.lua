...
function Panel_Worldmap_MovieGuide_Close()
	if ( worldMapMovieList._panel:GetShow() == true ) then
		...
		elseif isGameTypeJapan() then
			Panel_MovieTheater640_GameGuide_Func(17)
		end
...
function Panel_Worldmap_MovieGuide_Func()
	...
	elseif isGameTypeEnglish() then
		...
		worldMapMovieList._btn_Movie_4:addInputEvent( "Mouse_LUp", "Panel_MovieTheater640_GameGuide_Func(" .. 20 .. ")" )
	elseif isGameTypeJapan() then
		worldMapMovieList._btn_Movie_1:addInputEvent( "Mouse_LUp", "Panel_MovieTheater640_GameGuide_Func(" .. 17 .. ")" )
		worldMapMovieList._btn_Movie_2:addInputEvent( "Mouse_LUp", "Panel_MovieTheater640_GameGuide_Func(" .. 18 .. ")" )
		worldMapMovieList._btn_Movie_3:addInputEvent( "Mouse_LUp", "Panel_MovieTheater640_GameGuide_Func(" .. 21 .. ")" )
		worldMapMovieList._btn_Movie_4:addInputEvent( "Mouse_LUp", "Panel_MovieTheater640_GameGuide_Func(" .. 26 .. ")" )
	end
